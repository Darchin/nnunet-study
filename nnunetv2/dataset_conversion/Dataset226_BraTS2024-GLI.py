...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description="Convert BraTS 2024 Adult Glioma (GLI) dataset to nnU-Net format.")
    parser.add_argument('input_folder', type=str,
                        help="The downloaded and extracted BraTS 2024 GLI dataset directory containing case subfolders "
                             "(e.g., BraTS-GLI-XXXXX-XXX).")
    parser.add_argument('-d', required=False, type=int, default=226,
                        help='nnU-Net Dataset ID, default: 226')
    parser.add_argument('-t', '--task_name', required=False, type=str, default='BraTS2024_GLI',
